...
(function attachPanHandlers(){
  const c = __getCanvasEl();
  if (!c) return;
  // Prevent browser gestures from hijacking pointer moves
  ...
  c.addEventListener("pointerdown", (e) => {
    ...
    __dragStartCamX = camX;
    __dragStartCamY = camY;
  ...
  c.addEventListener("pointermove", (e) => {
    ...
    const { wx, wy } = __toWorldDelta(dx, dy);
    // Dragging the view: move camera opposite the pointer movement
    camX = __dragStartCamX - wx;
    camY = __dragStartCamY - wy;
  });
